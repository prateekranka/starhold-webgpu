...
The menu uses the existing Starhold palette and remains readable at desktop, portrait-phone, landscape-phone and tablet viewport sizes. Native `<dialog>` semantics provide focus/inert behavior while the menu is open.
